...
namespace GlobalLowLevelHooks
{
    ...
    /// (From https://github.com/rvknth043/Global-Low-Level-Key-Board-And-Mouse-Hook).
    /// </summary>
    public class KeyboardHook
    {
        ...
        public static VKeys StringToVKey(string input)
        {
            VKeys keyToReturn = VKeys.KEY_0;
            if (input == "1")
                keyToReturn = VKeys.KEY_1;
            else if (input == "2")
                keyToReturn = VKeys.KEY_2;
            else if (input == "3")
                keyToReturn = VKeys.KEY_3;
            else if (input == "4")
                keyToReturn = VKeys.KEY_4;
            else if (input == "5")
                keyToReturn = VKeys.KEY_5;
            else if (input == "6")
                keyToReturn = VKeys.KEY_6;
            else if (input == "7")
                keyToReturn = VKeys.KEY_7;
            else if (input == "8")
                keyToReturn = VKeys.KEY_8;
            else if (input == "9")
                keyToReturn = VKeys.KEY_9;
            else if (input == "0")
                keyToReturn = VKeys.KEY_0;
            else if (input == "-")
                keyToReturn = VKeys.KEY_2;
            else if (input == "=")
                keyToReturn = VKeys.KEY_3;
            else if (input == "Backspace")
                keyToReturn = VKeys.BACK;
            else if (input == "Tab")
                keyToReturn = VKeys.TAB;
            else if (input == "Q")
                keyToReturn = VKeys.KEY_Q;
            else if (input == "W")
                keyToReturn = VKeys.KEY_W;
            else if (input == "E")
                keyToReturn = VKeys.KEY_E;
            else if (input == "R")
                keyToReturn = VKeys.KEY_R;
            else if (input == "T")
                keyToReturn = VKeys.KEY_T;
            else if (input == "Y")
                keyToReturn = VKeys.KEY_Y;
            else if (input == "U")
                keyToReturn = VKeys.KEY_U;
            else if (input == "I")
                keyToReturn = VKeys.KEY_I;
            else if (input == "O")
                keyToReturn = VKeys.KEY_O;
            else if (input == "P")
                keyToReturn = VKeys.KEY_P;
            else if (input == "Caps")
                keyToReturn = VKeys.CAPITAL;
            else if (input == "A")
                keyToReturn = VKeys.KEY_A;
            else if (input == "S")
                keyToReturn = VKeys.KEY_S;
            else if (input == "D")
                keyToReturn = VKeys.KEY_D;
            else if (input == "F")
                keyToReturn = VKeys.KEY_F;
            else if (input == "G")
                keyToReturn = VKeys.KEY_G;
            else if (input == "H")
                keyToReturn = VKeys.KEY_H;
            else if (input == "J")
                keyToReturn = VKeys.KEY_J;
            else if (input == "K")
                keyToReturn = VKeys.KEY_K;
            else if (input == "L")
                keyToReturn = VKeys.KEY_L;
            else if (input == "Enter")
                keyToReturn = VKeys.RETURN;
            else if (input == "L Shift")
                keyToReturn = VKeys.LSHIFT;
            else if (input == "Z")
                keyToReturn = VKeys.KEY_Z;
            else if (input == "X")
                keyToReturn = VKeys.KEY_X;
            else if (input == "C")
                keyToReturn = VKeys.KEY_C;
            else if (input == "V")
                keyToReturn = VKeys.KEY_V;
            else if (input == "B")
                keyToReturn = VKeys.KEY_B;
            else if (input == "N")
                keyToReturn = VKeys.KEY_N;
            else if (input == "M")
                keyToReturn = VKeys.KEY_M;
            else if (input == "<")
                keyToReturn = VKeys.OEM_COMMA;
            else if (input == ">")
                keyToReturn = VKeys.OEM_PERIOD;
            else if (input == "R Shift")
                keyToReturn = VKeys.RSHIFT;
            else if (input == "L Ctrl")
                keyToReturn = VKeys.LCONTROL;
            else if (input == "L Alt")
                keyToReturn = VKeys.LMENU;
            else if (input == "Spacebar")
                keyToReturn = VKeys.SPACE;
            else if (input == "R Alt")
                keyToReturn = VKeys.RMENU;
            else if (input == "R Ctrl")
                keyToReturn = VKeys.RCONTROL;
            else if (input == "RMB")
                keyToReturn = VKeys.RBUTTON;
            else if (input == "LMB")
                keyToReturn = VKeys.LBUTTON;
